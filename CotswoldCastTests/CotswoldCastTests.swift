...
class CotswoldCastTests: XCTestCase {
    ...
    func testFullParse() throws {
        ...
        let sampleFullWeather = try decoder.decode(WeatherDataContainer.self, from: sampleFullWeatherData)

        let weather1 = sampleFullWeather.list[0]
        let weather2 = sampleFullWeather.list[8]
